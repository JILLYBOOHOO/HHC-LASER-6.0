  ...
  template: `
    <div class="min-h-[70vh] flex items-center justify-center p-4">
      <div class="text-center max-w-md">
        ...
        <h1 class="text-4xl font-heading text-charcoal-800 mb-4">Access Denied</h1>
        ...
        <a routerLink="/auth/login" mat-flat-button class="!bg-charcoal-900 !text-cream-50 mr-4">Go to Login</a>

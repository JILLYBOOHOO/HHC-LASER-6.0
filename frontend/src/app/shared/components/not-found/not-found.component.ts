...
@Component({
  ...
  template: `
    <div class="min-h-[70vh] flex flex-col items-center justify-center p-4">
      ...
      <h2 class="text-3xl font-heading text-charcoal-800 mb-6">Page Not Found</h2>
      ...
      <a routerLink="/" mat-flat-button class="!bg-charcoal-900 !text-cream-50 px-8 py-2">Back to Home</a>
    </div>
  `
})

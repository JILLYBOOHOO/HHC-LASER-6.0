...
export const routes: Routes = [
  // ─── Public Website ─────────────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      // Google sitelink "Create an account" / related legacy URLs
      { path: 'create-account', redirectTo: '/auth/register', pathMatch: 'full' },
      { path: 'create-an-account', redirectTo: '/auth/register', pathMatch: 'full' },
      { path: 'create an account', redirectTo: '/auth/register', pathMatch: 'full' },
      { path: 'Create an account', redirectTo: '/auth/register', pathMatch: 'full' },
      { path: 'Create-An-Account', redirectTo: '/auth/register', pathMatch: 'full' },
      { path: 'create_account', redirectTo: '/auth/register', pathMatch: 'full' },

    ...
    <div class="min-h-screen bg-background pt-32 pb-16 overflow-hidden">
      ...
      <section class="container-luxury px-6 mb-24 animate-fade-in-up">
        <div class="max-w-4xl mx-auto text-center">
                    <h1 class="mt-4 font-heading text-4xl md:text-5xl lg:text-6xl text-black leading-tight mb-8 drop-shadow-lg">
          ...
          <div class="mt-8 space-y-6 text-text-muted text-lg font-light leading-relaxed max-w-3xl mx-auto">
            <p>
              At HHC Laser & Co, we believe confidence begins with exceptional care. Our mission is to help every client look and feel their best through advanced medical aesthetics, personalized treatment plans, and a commitment to safety, excellence, and natural-looking results.
            </p>
            <p>
      ...
      <section class="container-luxury px-6 mb-32">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div class="relative h-[600px] rounded-3xl overflow-hidden shadow-gold-lg group">
            <img loading="lazy" src="/images/wood_therapy_-_1.jpg" alt="HHC Laser Clinic" class="w-full h-full object-cover transition-transform duration-[10000ms] group-hover:scale-110">
            <div class="absolute inset-0 bg-black/20 pointer-events-none"></div>
          </div>
          <div class="space-y-6 animate-fade-in-up" style="animation-delay: 0.2s;">
            <span class="section-label">Our Story</span>
            <h2 class="font-heading text-3xl md:text-4xl text-black">A Destination for Excellence</h2>
            <div class="divider-gold-left"></div>
            <div class="space-y-6 text-text-muted text-base font-light leading-relaxed">
              <p>
                Located in the heart of Kingston, Jamaica, HHC Laser & Co has become a trusted destination for individuals seeking advanced medical spa treatments using modern technology and evidence-based techniques.
              </p>
              <div class="border-l-2 border-gold pl-6 py-2 my-8">
                <p class="text-xl text-black font-heading italic leading-relaxed">
      ...
      <section class="bg-surface py-24 mb-32 relative border-y border-white/5">
        ...
        <div class="container-luxury px-6 relative z-10">
          <div class="text-center max-w-2xl mx-auto mb-16 animate-fade-in-up">
            ...
            <h2 class="mt-4 font-heading text-3xl md:text-4xl text-black">Why Choose HHC Laser?</h2>
            <div class="divider-gold mx-auto"></div>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Feature 1 -->
            <div class="bg-black p-10 rounded-3xl border border-white/10 shadow-2xl group hover:-translate-y-2 transition-all duration-300">
              <div class="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mb-6 border border-gold/30 group-hover:bg-gold/20 transition-colors">
                <mat-icon class="text-gold !text-3xl !w-8 !h-8">science</mat-icon>
              </div>
              <h3 class="text-white font-heading text-2xl mb-4 font-bold">Advanced Technology</h3>
              <p class="text-neutral-200 font-normal leading-relaxed">We invest in industry-leading equipment and modern treatment techniques to deliver safe, effective, and reliable results.</p>
            </div>
            <!-- Feature 2 -->
            <div class="bg-black p-10 rounded-3xl border border-white/10 shadow-2xl group hover:-translate-y-2 transition-all duration-300">
              <div class="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mb-6 border border-gold/30 group-hover:bg-gold/20 transition-colors">
              ...
              <h3 class="text-white font-heading text-2xl mb-4 font-bold">Personalized Plans</h3>
              <p class="text-neutral-200 font-normal leading-relaxed">Every client is unique. We take the time to understand your concerns and develop treatment plans designed specifically for your needs.</p>
            </div>
            <!-- Feature 3 -->
            <div class="bg-black p-10 rounded-3xl border border-white/10 shadow-2xl group hover:-translate-y-2 transition-all duration-300">
              <div class="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mb-6 border border-gold/30 group-hover:bg-gold/20 transition-colors">
              ...
              <h3 class="text-white font-heading text-2xl mb-4 font-bold">Safety & Excellence</h3>
              <p class="text-neutral-200 font-normal leading-relaxed">Your health and safety are always our highest priority. Every procedure follows strict clinical protocols using FDA-approved equipment.</p>
            </div>
            <!-- Feature 4 -->
            <div class="bg-black p-10 rounded-3xl border border-white/10 shadow-2xl group hover:-translate-y-2 transition-all duration-300">
              <div class="w-16 h-16 rounded-full bg-gold/10 flex items-center justify-center mb-6 border border-gold/30 group-hover:bg-gold/20 transition-colors">
              ...
              <h3 class="text-white font-heading text-2xl mb-4 font-bold">Experienced Professionals</h3>
              <p class="text-neutral-200 font-normal leading-relaxed">Our highly trained team combines medical knowledge with years of practical experience to deliver exceptional care and outstanding client experiences.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="container-luxury px-6 mb-32">
        <div class="text-center max-w-2xl mx-auto mb-16 animate-fade-in-up">
          ...
          <h2 class="mt-4 font-heading text-3xl md:text-4xl text-black">Our Core Values</h2>
          <div class="divider-gold mx-auto"></div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div class="border border-white/5 bg-surface-light rounded-3xl p-8 hover:border-gold/30 hover:bg-surface-light/80 transition-all duration-300 flex flex-col items-center text-center group">
            ...
            <h4 class="text-black font-semibold mb-3 tracking-wide text-lg">Compassionate Care</h4>
          ...
          <div class="border border-white/5 bg-surface-light rounded-3xl p-8 hover:border-gold/30 hover:bg-surface-light/80 transition-all duration-300 flex flex-col items-center text-center group">
            ...
            <h4 class="text-black font-semibold mb-3 tracking-wide text-lg">Safety First</h4>
          ...
          <div class="border border-white/5 bg-surface-light rounded-3xl p-8 hover:border-gold/30 hover:bg-surface-light/80 transition-all duration-300 flex flex-col items-center text-center group">
            ...
            <h4 class="text-black font-semibold mb-3 tracking-wide text-lg">Excellence</h4>
          ...
          <div class="border border-white/5 bg-surface-light rounded-3xl p-8 hover:border-gold/30 hover:bg-surface-light/80 transition-all duration-300 flex flex-col items-center text-center group">
            ...
            <h4 class="text-black font-semibold mb-3 tracking-wide text-lg">Integrity</h4>
        ...
        <div class="container-luxury px-6 relative z-10">
          <div class="grid grid-cols-2 md:grid-cols-4 gap-12 text-center divide-x divide-white/5">
            <div class="space-y-3 animate-fade-in-up" style="animation-delay: 0.1s;">
              ...
              <div class="text-black text-xs md:text-sm font-semibold tracking-[0.2em] uppercase">Years Experience</div>
            </div>
            <div class="space-y-3 animate-fade-in-up" style="animation-delay: 0.2s;">
              ...
              <div class="text-black text-xs md:text-sm font-semibold tracking-[0.2em] uppercase">Satisfied Clients</div>
            </div>
            <div class="space-y-3 animate-fade-in-up" style="animation-delay: 0.3s;">
              ...
              <div class="text-black text-xs md:text-sm font-semibold tracking-[0.2em] uppercase">Advanced Services</div>
            </div>
            <div class="space-y-3 animate-fade-in-up" style="animation-delay: 0.4s;">
              ...
              <div class="text-black text-xs md:text-sm font-semibold tracking-[0.2em] uppercase">Client Satisfaction</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="container-luxury px-6 mb-16 animate-fade-in-up">
        <div class="bg-black rounded-[2rem] p-12 md:p-20 text-center relative overflow-hidden border border-gold/30 shadow-2xl">
          ...
          <div class="relative z-10 max-w-3xl mx-auto">
            <h2 class="font-heading text-4xl md:text-5xl text-white mb-6 drop-shadow-lg font-bold">Begin Your Transformation</h2>
            <div class="text-neutral-200 text-lg font-normal leading-relaxed mb-10 space-y-4">
              <p>
...
export class AboutComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.seo.updatePage({
      ...
      description: 'Learn about HHC Laser & Co., Kingston Jamaica\'s trusted medical spa and aesthetic clinic. Our certified team specializes in laser treatments, Botox, dermal fillers, skin rejuvenation, and holistic wellness at our Mannings Hill and Constant Spring Road locations.',
      canonicalPath: '/about',
      keywords: 'About HHC Laser Jamaica, Medical Aesthetic Clinic Kingston, HHC Laser & Co Jamaica, Med Spa Team Jamaica, Aesthetic Professionals Kingston',
    });

  ...
  template: `
    <div class="space-y-6">
      ...
      @if (loading()) {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div class="bg-gray-900 border border-gray-800 rounded-lg p-5">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-xl text-white font-medium">{{ status()?.apiStatus || 'Unknown' }}</span>
            </div>
          </div>
          ...
          <div class="bg-gray-900 border border-gray-800 rounded-lg p-5">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-xl text-white font-medium">{{ status()?.dbStatus || 'Unknown' }}</span>
            </div>
          </div>
          ...
          <div class="bg-gray-900 border border-gray-800 rounded-lg p-5">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-xl text-white font-medium">{{ status()?.openErrors || 0 }}</span>
            </div>
          </div>
          ...
          <div class="bg-gray-900 border border-gray-800 rounded-lg p-5">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xl text-white font-medium">{{ status()?.uptime | number:'1.0-0' }}</span>
            </div>
          </div>
        ...
        <!-- Entity Counts -->
        <h2 class="text-lg font-bold text-white mt-8 mb-4">Entity Statistics</h2>

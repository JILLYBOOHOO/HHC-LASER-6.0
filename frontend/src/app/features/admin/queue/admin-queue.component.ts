...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-white text-slate-800 p-6 md:p-8 font-sans selection:bg-[#00f0ff] selection:text-black">
      ...
      <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
        ...
        <div class="relative flex-1 max-w-xl">
          ...
          <input type="text"
                 ...
                 class="w-full pl-12 pr-4 py-3 bg-white border border-slate-200 rounded-md text-sm font-semibold text-black placeholder-slate-500 focus:outline-none focus:border-[#00f0ff] transition-all">
        </div>
        ...
        <div class="flex items-center gap-4 self-end lg:self-auto">
          ...
          <button class="p-2 text-slate-500 hover:text-black transition-colors"><mat-icon>notifications</mat-icon></button>
          <button class="p-2 text-slate-500 hover:text-black transition-colors"><mat-icon>settings</mat-icon></button>
          <button class="p-2 text-slate-500 hover:text-black transition-colors"><mat-icon>account_circle</mat-icon></button>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <!-- Avg Wait Time Card -->
        <div class="bg-white border border-slate-200 p-5 rounded-lg flex flex-col justify-between h-32">
          <div class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">AVG. WAIT TIME</div>
          <div class="text-5xl font-black text-amber-400 tracking-tight">14m</div>
          <div class="text-xs text-slate-500 font-medium">Optimal range: <15m</div>
        </div>
        ...
        <div class="bg-white border border-slate-200 p-5 rounded-lg flex flex-col justify-between h-32">
          ...
          <div class="text-xs text-slate-500 font-medium">4 rooms occupied</div>
        </div>
      ...
      <div class="bg-white border border-slate-200 rounded-lg mb-8">
        ...
        <div class="px-6 py-5 flex items-center justify-between border-b border-slate-200">
          ...
          <div class="flex items-center gap-3">
            <button class="px-4 py-1.5 bg-white border border-slate-300 text-slate-700 text-xs font-semibold rounded hover:bg-slate-100 flex items-center gap-2">
        ...
        <!-- Table Header -->
        <div class="grid grid-cols-12 gap-4 px-6 py-3 border-b border-slate-200 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
        ...
        <div class="divide-y divide-slate-200">
          ...
          <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-50 transition-colors">
            ...
            <div class="col-span-2 text-xs font-medium text-slate-700">
              09:15<br><span class="text-[10px] text-slate-500">AM</span>
            </div>
            <div class="col-span-2 text-xs font-medium text-slate-700">09:30 AM</div>
            <div class="col-span-2">
              <span class="px-2 py-1 bg-slate-100 text-slate-700 text-[10px] rounded border border-slate-300">Laser Rejuvenation</span>
            </div>
            <div class="col-span-2 flex items-center justify-end">
              <div class="flex rounded-full overflow-hidden border border-slate-300 bg-white">
                ...
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">CHECK-IN</button>
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">TREATMENT</button>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-50 transition-colors">
            ...
            <div class="col-span-2 text-xs font-medium text-slate-700">09:00 AM</div>
            <div class="col-span-2">
              <span class="px-2 py-1 bg-slate-100 text-slate-700 text-[10px] rounded border border-slate-300">Scar Therapy</span>
            </div>
            <div class="col-span-2 flex items-center justify-end">
              <div class="flex rounded-full overflow-hidden border border-slate-300 bg-white">
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">ARRIVED</button>
          ...
          <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center bg-blue-50 border-l-2 border-[#4185f4]">
            <div class="col-span-4 flex items-center gap-4">
            ...
            <div class="col-span-2 text-xs font-medium text-slate-700">08:30 AM</div>
            <div class="col-span-2">
              <span class="px-2 py-1 bg-slate-100 text-slate-700 text-[10px] rounded border border-slate-300">Deep Pulse Laser</span>
            </div>
            <div class="col-span-2 flex items-center justify-end">
              <div class="flex rounded-full overflow-hidden border border-slate-300 bg-white">
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">CHECKED IN</button>
                <button class="px-3 py-1 text-[9px] font-bold bg-[#4185f4] text-black">IN TREATMENT</button>
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">CHECKOUT</button>
              </div>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 gap-4 px-6 py-4 items-center hover:bg-slate-50 transition-colors">
            <div class="col-span-4 flex items-center gap-4">
              <div class="w-10 h-10 rounded bg-[#2a2e2c] text-slate-700 font-bold flex items-center justify-center">SP</div>
              <div>
            ...
            <div class="col-span-2 text-xs font-medium text-slate-700">08:15 AM</div>
            <div class="col-span-2">
              <span class="px-2 py-1 bg-slate-100 text-slate-700 text-[10px] rounded border border-slate-300">Skin Analysis</span>
            </div>
            <div class="col-span-2 flex items-center justify-end">
              <div class="flex rounded-full overflow-hidden border border-slate-300 bg-white">
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">TREATMENT</button>
                <button class="px-3 py-1 text-[9px] font-bold bg-[#a472f7] text-black">READY FOR CHECKOUT</button>
                <button class="px-3 py-1 text-[9px] font-bold text-slate-500 hover:text-black">DONE</button>
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="bg-white border border-slate-200 rounded-lg p-6">
          ...
          <div class="space-y-4">
            <!-- Alert 1 -->
            <div class="bg-white border-l-4 border-[#ff6b6b] p-4 rounded-r-lg flex gap-4">
              ...
              <div>
                ...
                <div class="text-xs font-mono text-slate-500 mt-1">Appointment 09:45 AM - Still not arrived. Contact initiated.</div>
              </div>
            </div>

            <!-- Alert 2 -->
            <div class="bg-white border-l-4 border-amber-400 p-4 rounded-r-lg flex gap-4">
              ...
              <div>
                ...
                <div class="text-xs font-mono text-slate-500 mt-1">Average wait time has exceeded 15m. Check Room 02 turnover.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border border-slate-200 rounded-lg p-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <!-- Staff 4 -->
            <div class="bg-white border border-slate-200 rounded-lg p-3 flex items-center gap-3 opacity-60">
              <div class="w-10 h-10 rounded bg-white flex items-center justify-center text-slate-600">

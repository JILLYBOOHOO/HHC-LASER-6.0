...
router.post('/', async (req, res, next) => {
    try {
       ...
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [category_id, name, slug, description, price_jmd, duration_minutes, thumbnail_url, is_featured ? true : false, is_active ? true : false, gallery_images ? JSON.stringify(gallery_images) : null]);
...
router.put('/:id', async (req, res, next) => {
    try {
       ...
       WHERE id=?`, [category_id, name, slug, description, price_jmd, duration_minutes, thumbnail_url, is_featured ? true : false, is_active ? true : false, gallery_images ? JSON.stringify(gallery_images) : null, req.params['id']]);

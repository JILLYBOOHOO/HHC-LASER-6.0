...
class EmailService {
     ...
     */
    static async sendBookingConfirmation(toEmail, firstName, appointmentDetails, confirmationCode) {
    ...
    `;
        try {
            ...
            logger_1.logger.info(`[EmailService] Confirmation email sent to ${toEmail}. Message ID: ${info.messageId}`);
        }
        catch (e) {
            logger_1.logger.error('[EmailService] Error sending confirmation email via Nodemailer', e);
        }
    }
}
